...
urlpatterns = [
    ...
    path('check_email_user/', check_email_user, name='check_email_user'),
    path('check_email_freelancer/', check_email_freelancer, name='check_email_freelancer'),
    path('view_skills/', view_skills_serializer, name='view_skills'),
 ]
