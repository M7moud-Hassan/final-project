...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='static_dirs/images/project_image')),
            ],
        ),
        migrations.CreateModel(
            name='WorkHistory',
            fields=[
                ...
                ('cons', models.DecimalField(decimal_places=5, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ManyToManyField(to='profile_app.imagesproject')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_user_free', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.registerfreelancer')),
            ],
        ),
    ]
