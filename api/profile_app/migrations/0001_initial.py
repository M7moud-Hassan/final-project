    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_history_client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.registeruser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Credit_number', models.CharField(max_length=16)),
                ('CVV', models.CharField(max_length=3)),
                ('free_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.registerfreelancer')),
            ],
        ),
        migrations.CreateModel(
